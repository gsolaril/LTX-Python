...
class ExecReceiver(StreamingAgent):
    ...
    VERBOSE_NO_BTID: ClassVar[str] = "Autogenerated BTID \"{}\" (not recommended for prod)\""
    ...
    def __post_init__(self):
        ...
        if (self.id is None):
            self.id = b64()
            Log.warning(self.VERBOSE_NO_BTID.format(self.id))
    ...
    async def main(self):
        ...
        ex_key = (self.stream_prefix, self.STREAM_MIDFIX, self.id)
